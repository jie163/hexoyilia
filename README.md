...
崇尚简约优雅，以及极致的性能。 你可以点击 [我的博客](https://jie163.github.io/) 查看效果。           
...
``` bash
$ git clone https://github.com/jie163/hexoyilia.git themes/yilia
```
...
#具体请参考wiki：https://github.com/jie163/hexoyilia/wiki/
